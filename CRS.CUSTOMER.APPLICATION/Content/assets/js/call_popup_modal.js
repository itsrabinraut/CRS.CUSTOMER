                    ...
                    <div class="relative w-full max-w-2xl max-h-full" style="top:25%;">
                        ...
                        <div class="relative bg-white  shadow dark:bg-gray-700 rounded-[6px]">
                            ...
                            <div class=" bg-white rounded-[6px]" style="padding-top:38px;">
                                ...
                                <div class="" style="padding-bottom:28px"><a style="text-align:center;line-height:130%" class="text-[#D75A8B] text-[12px] underline cursor-pointer  font-[600] flex justify-center" onclick="bookNowPopup('${clubId}')">ネット予約でポイントを獲得する</a></div>
                            </div>
                        </div>
                    </div>
                </div>
